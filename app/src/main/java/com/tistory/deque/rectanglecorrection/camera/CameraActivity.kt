...
class CameraActivity : BaseActivity<BaseViewModel>(), CameraBridgeViewBase.CvCameraViewListener2 {

    override val layoutResourceId: Int get() = R.layout.activity_camera
    override val viewModel: BaseViewModel
        get() = ViewModelProviders.of(this).get(CameraViewModel::class.java)
    ...
    private val mLoaderCallback = object : BaseLoaderCallback(this) {
        override fun onManagerConnected(status: Int) {
            when (status) {
                LoaderCallbackInterface.SUCCESS -> activity_camera_surface_view?.enableView()
    ...
    override fun initStartView() {
        ...
        activity_camera_surface_view.run {
    ...
    override fun onPause() {
        super.onPause()
        activity_camera_surface_view?.disableView()
    }
